...
// Artifact types produced by the GPT-4o generators — rendered in full in the appendix
...
export function buildEvidenceDocument(summary, nextSteps = {}) {
  ...
  if (nextSteps.error) {
    ...
    children.push(body('Recommendations generated by Azure OpenAI GPT-4o from the gap analysis above; review before sharing.', { size: 18, italics: true, color: '888888' }))
  }
